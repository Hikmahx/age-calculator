...
const Calendar = () => {
  ...
  return (
    <div
      className="absolute right-2 sm:right-4 top-12 z-10 w-full bg-white shadow-[0px_4px_30px_0px_rgba(0,0,0,0.25)] rounded-lg max-w-[342px] lg:max-h-[302px] px-4 py-5 lg:px-8 lg:py-6 mt-4 mx-auto overflow-hidden flex-1 font-light collapse"
      id="collapseExample"
    >
